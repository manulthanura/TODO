    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6>Logged as: <?php echo $_SESSION['username']; ?></h6>
        </nav>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Available Tasks</p>
                    <h5 class="font-weight-bolder mb-0">
                      <?php echo $available_tasks ?>
                    </h5>
                  </div>
                </div>
          ...
          <div class="card">
            ...
            <div class="card-body px-0 pb-2">
              ...
              <div class="text-center">
                    <p class="text-sm">You don't have any tasks yet!</p>
              </div>
              <?php else: ?>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><?php echo $task['title']; ?></h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <div class="avatar-group mt-2">
                            <span class="text-xs font-weight-bold"><?php echo $task['priority']; ?></span>
                        </div>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <span class="text-xs font-weight-bold"><?php echo $task['date_created']; ?></span>
                      </td>
